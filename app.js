...
function initAuth() {
  ...
  auth.client.auth.onAuthStateChange((event, session) => {
    ...
    renderAuthArea();
    if (event === 'SIGNED_IN') showToast(`✅ Signed in as ${auth.currentUser.email}`);
    ...
    root.innerHTML = `
      <div class="auth-wrap">
        ...
        <div class="auth-menu" id="authMenu">
          ...
          <button class="auth-menu-item" disabled style="opacity:0.5;cursor:not-allowed;">☁ Sync coming soon</button>
